...
def search(num_days):
    ...
    urls = []
    key_words = []
    urls.append("http://www.zergwatch.com/category/wall-street-coverage/page/")
    key_words.append("Stock Market")
    urls.append("http://www.zergwatch.com/category/analyst-opinions/page/")
    key_words.append("Analyst Opinions")
    urls.append("http://www.zergwatch.com/category/worldmarkets2016/page/")
    key_words.append("World Markets")
    urls.append("http://www.zergwatch.com/category/earning-estimates/page/")
    key_words.append("Earning Estimates")
    ...
    while num_urls_searched < len(urls):
        ...
        # If page is not complete, move to the next site
        if len(parse3_links) < 9:
            ...
            print ''
            continue
        # Else keep only the first 9 links
        else:
        ...
        for link in parse3_links:
            ...
            while n < len(dates) - 4:
                if date == dates[n]:
                    ...
                    current_article.set_name(link.contents[0])
