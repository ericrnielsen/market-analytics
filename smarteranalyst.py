...
def search(num_days):
    ...
    urls = []
    urls.append("http://www.smarteranalyst.com/category/analyst-news/page/")
    urls.append("http://www.smarteranalyst.com/category/stock-news/page/")
    ...
    while num_urls_searched < len(urls):
        ...
        for link in main_links:
            ...
            cut1 = re.sub("http://www.smarteranalyst.com/", "", href, count = 1)
