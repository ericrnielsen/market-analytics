...
def search(num_days):
    ...
    urls = []
    urls.append("http://www.streetupdates.com/category/health/page/")
    urls.append("http://www.streetupdates.com/category/technology/page/")
    urls.append("http://www.streetupdates.com/category/research-analysis/page/")
    urls.append("http://www.streetupdates.com/category/sector-update/page/")
    urls.append("http://www.streetupdates.com/category/business-headlines/page/")
    urls.append("http://www.streetupdates.com/category/world-update/page/")
    ...
    while num_urls_searched < len(urls):
        ...
        main_links = parsed_html.find_all('h4')
        ...
        for link in main_links:
            ...
            cut1 = re.sub("http://www.streetupdates.com/", "", href, count = 1)
