...
def get_financial_dataAPI(master_tickers, master_stock_data, run_type, selections, startDate, endDate):
...
def compute_stock_metricsAPI(master_stock_data, run_type, selections):
